...
class Arguments:
    def __init__(self, agent, env=None, env_func=None, env_args=None):
        ...
        self.if_off_policy = True  # off-policy
        ...
        """HER"""
        self.HER_sample_num = 4
        self.dir_name = 'HER'
        self.mode = 'train'


    def init_before_training(self):
        self.target_step = self.max_step * 2
        self.reward_scale = 2 ** -1
        self.gamma = 0.998

        self.net_dim = 2 ** 7
        self.layer_num = 3
        self.batch_size = int(self.net_dim * 2)
        self.repeat_times = 2 ** 4

        self.eval_times = 2 ** 5

        self.lambda_h_term = 2 ** -5
